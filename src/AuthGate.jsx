...
export default function AuthGate({children}){
  ...
  if(!user)return <AuthScreen mode={mode} setMode={setMode} email={email} setEmail={setEmail} password={password} setPassword={password} busy={busy} message={message} onSubmit={submit} onGoogle={googleSignIn}/>;

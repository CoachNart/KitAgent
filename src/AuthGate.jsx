 ...
 return <div className="auth-screen">
   ...
   <main className="auth-layout">
     ...
     {interactive&&<form onSubmit={onSubmit} className="auth-form">
       ...
       {isSignin&&<button type="button" className="auth-forgot" onClick={()=>{setMode('reset');setMessage('');setPassword('')}}>Forgot password?</button>}

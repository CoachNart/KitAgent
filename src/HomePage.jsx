...
import {ArrowDownRight,ArrowUpRight,BarChart3,ChevronRight,Clock3,Layers3,RefreshCw,TrendingUp,Wallet,Zap} from 'lucide-react';
...
export default function HomePage({go,wallet}){
 ...
 return <div className="home-page">
  <section className="home-top">
   <div><span className="tiny-label">MARKET OVERVIEW</span><h1>Good to see you.</h1><p>Markets move. KitAgent keeps you close to the signal.</p></div>

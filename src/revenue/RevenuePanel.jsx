...
export default function RevenuePanel(){
 ...
 return <section className="revenue-page">
  ...
  <div className="revenue-grid">
   ...
   <div className="revenue-card"><span className="card-kicker">PRO</span><h3>$19 / month</h3><p>Unlimited smart execution, automation, gas optimization, advanced simulation and multi-wallet workflows.</p><button className="revenue-cta" onClick={()=>subscribe('pro')}>Activate Pro</button></div>
   <div className="revenue-card"><span className="card-kicker">INFRASTRUCTURE</span><h3>From $99 / month</h3><p>API, white-label agent, usage analytics and embedded execution for wallets, fintechs, DAOs and Web3 apps.</p><button className="ghost-action" onClick={()=>subscribe('developer')}>Build with KitAgent</button></div>
  </div>

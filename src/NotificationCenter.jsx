...
const button={position:'fixed',right:18,top:18,zIndex:1200,width:40,height:40,borderRadius:12,border:'1px solid rgba(255,255,255,.12)',background:'rgba(10,14,20,.78)',backdropFilter:'blur(14px)',color:'#fff',display:'grid',placeItems:'center',cursor:'pointer'};
...
const panel={position:'fixed',right:18,top:66,zIndex:1199,width:'min(360px,calc(100vw - 36px))',border:'1px solid rgba(255,255,255,.12)',borderRadius:18,background:'rgba(12,16,23,.96)',backdropFilter:'blur(18px)',color:'#fff',boxShadow:'0 20px 60px rgba(0,0,0,.4)',padding:16};

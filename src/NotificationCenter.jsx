...
const badge={position:'absolute',right:-2,top:-2,minWidth:15,height:15,borderRadius:99,background:'#ef4444',fontSize:9,fontWeight:800,display:'grid',placeItems:'center',padding:'0 3px',lineHeight:1};
const panelEmbedded={position:'absolute',right:0,top:'calc(100% + 7px)',zIndex:1400,width:'min(310px,calc(100vw - 20px))',maxWidth:'calc(100vw - 20px)',border:'1px solid rgba(255,255,255,.12)',borderRadius:12,background:'rgba(12,16,23,.98)',backdropFilter:'blur(18px)',color:'#fff',boxShadow:'0 16px 38px rgba(0,0,0,.42)',padding:12,boxSizing:'border-box',overflow:'hidden',fontFamily:'Inter, ui-sans-serif, -apple-system, BlinkMacSystemFont, "Segoe UI", sans-serif'};
const panel={display:'none'};
const head={display:'flex',justifyContent:'space-between',alignItems:'center',marginBottom:11};
const row={display:'flex',gap:5,marginBottom:6,minWidth:0};
const field={minWidth:0,width:0,flex:1,padding:'7px 8px',borderRadius:7,border:'1px solid rgba(255,255,255,.1)',background:'rgba(255,255,255,.055)',color:'#fff',outline:'none',fontSize:11,lineHeight:1.35};
...
const sub={fontSize:11,opacity:.62,marginTop:3,lineHeight:1.4};
const meta={fontSize:10,opacity:.48,marginTop:3,lineHeight:1.35};
const empty={fontSize:11,opacity:.48,padding:'8px 0',lineHeight:1.4};
...
const statusTopSpan={fontSize:10,lineHeight:1.35};
...
const sectionTitle={fontSize:9,letterSpacing:'.11em',fontWeight:800,opacity:.48,marginBottom:7,lineHeight:1.3};

...
const buttonEmbedded={position:'relative',width:34,height:34,borderRadius:10,border:'1px solid rgba(255,255,255,.09)',background:'transparent',color:'rgba(255,255,255,.72)',display:'grid',placeItems:'center',cursor:'pointer'};
const button={display:'none'};
const badge={position:'absolute',right:-2,top:-2,minWidth:15,height:15,borderRadius:99,background:'#ef4444',fontSize:9,fontWeight:800,display:'grid',placeItems:'center',padding:'0 2px'};
const panelEmbedded={position:'absolute',right:0,top:'calc(100% + 10px)',zIndex:1400,width:'min(360px,calc(100vw - 28px))',border:'1px solid rgba(255,255,255,.12)',borderRadius:18,background:'rgba(12,16,23,.97)',backdropFilter:'blur(18px)',color:'#fff',boxShadow:'0 20px 60px rgba(0,0,0,.4)',padding:16};

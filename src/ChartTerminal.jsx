...
export default function ChartTerminal(){
 ...
 return <div className="chart-terminal page-wrap">
   <div className="terminal-topbar">
    <div className="terminal-brand"><span className="terminal-kicker">KITSETUPS / WORKSPACE</span><div className="terminal-title"><BarChart3/><strong>Chart Terminal</strong><span className="terminal-sep">/</span><b>{displayPair(market,pair)}</b><span className="terminal-dot">·</span><b>{timeframe}</b></div></div>
   ...
   <section className="terminal-shell">
    ...
    <div className="terminal-chart-wrap">
      ...
      {!setup&&!loading&&<div className="chart-onboarding"><div className="onboard-icon"><CrosshairIcon/></div><span className="terminal-kicker">VISUAL CONFIRMATION</span><h2>Build a thesis. Then verify it.</h2><p>Load your latest Market Analysis setup or generate a new one. The chart stays the workspace; KitSetups stays read-only here.</p><button onClick={loadLatest}><Target size={14}/> Load latest setup</button></div>}

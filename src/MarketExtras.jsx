...
const STRATEGY_LIBRARY=[
 ...
 {key:'BREAKOUT',name:'Breakout',short:'Close → displacement → continuation',description:'Requires a compressed range, decisive close beyond the boundary, displacement and a subsequent retest/acceptance; wick-only breaks do not qualify.',rules:['Compressed range','Decisive close beyond boundary','Displacement','Retest / acceptance']},
...
export function StrategyExplanation({setup,strategy}){
 ...
 const detail={
  ...
  BREAKOUT:{entry:'Decisive close through structure with displacement; wick-only breaks are rejected.',invalidation:'The breakout fails back through the broken boundary before acceptance.',target:'Next qualified liquidity level after the break.'},
  ...
  PRICE_ACTION:{entry:'Meaningful swing level → rejection or engulfing confirmation at that level → market execution.',invalidation:'The structural level fails and invalidates the candle thesis.',target:'Next qualified structural/liquidity level with minimum 2.25R.'},

...
source=source.replace(/const nav=\[[^\n]*?\];/,"const nav=[['home','Home',House],['market','Market analysis',BarChart3],['defi','DeFi & actions',Layers3],['perps','Perpetuals',Zap],['drops','Airdrops & faucets',Rocket],['activity','History',History],['profile','Profile',UserRound]];");
...
// Guarantee a single authenticated Market Analysis import pair before Vite runs.
source=source.replace(/import AccessGate from '\.\/AccessGate\.jsx';\n/g,'');
source=source.replace(/import LiveMarketPage from '\.\/LiveMarketPage\.jsx';\n/g,'');
...
console.log('Activity track record, Profile navigation and authenticated Market imports normalized.');
